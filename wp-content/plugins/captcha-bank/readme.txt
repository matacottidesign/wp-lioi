...
Tags: captcha, recaptcha, google captcha, anti spam, text captcha
...
[**Captcha Bank**](https://tech-banker.com/captcha-bank/) is a powerful WordPress Captcha Plugin that protects your WordPress website from Spam.

* **[Captcha Bank](https://tech-banker.com/captcha-bank/)**
* **[Detailed Features](https://tech-banker.com/captcha-bank/)**
* **[Front End Demos](https://tech-banker.com/captcha-bank/frontend-demos/)**
* **[Back End Demos](https://tech-banker.com/captcha-bank/backend-demos/)**
* **[Documentation](https://tech-banker.com/blog/)**
* **[Upgrade to Premium Editions](https://tech-banker.com/captcha-bank/pricing/)**
...
There are lot of features also available in Premium Editions, you can check before downloading & purchasing. Click [here](https://tech-banker.com/captcha-bank/pricing/) for Captcha Bank Premium Editions.
...
* Minor Bug Fixe related to Exit Function on Detection of Proxy
...
* TWEAK: Locate IP Addreses API Changed
...
* FEATURE: Completely Revamped Layout
* FEATURE: Re-Captcha Introduced
* FEATURE: Whitelist IP Address/Range Added
* FEATURE: Blacklist IP Address/Range Added
* FIX: Major Bugs

= 4.0.19 =

* FIX: Major Bugs
* FIX: DB Collate & DB Charset Options
